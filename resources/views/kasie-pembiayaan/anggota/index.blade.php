@extends('layouts.kasie_pembiayaan', ['title' => 'Anggota','icon' => 'fas fa-address-book'])
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('kasie-pembiayaan.anggota.create') }}" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus mr-1"></i> Tambah Data</a>
                @if (request('search'))
                <div class="float-right">
                    <a href="{{ route('kasie-pembiayaan.anggota.index') }}" class="btn btn-sm btn-warning"><i class="fas fa-sync-alt mr-1"></i> Refresh</a>
                </div>
                @endif
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        <div class="btn-group dropleft">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('kasie-pembiayaan.anggota.show',$val->id) }}" class="dropdown-item"><i class="fas fa-eye"></i> Detail</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
