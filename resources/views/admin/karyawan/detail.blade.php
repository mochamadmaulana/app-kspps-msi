            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <strong><i class="fas fa-user-check mr-1"></i> Role</strong>
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="text-muted">
                            @if ($karyawan->kantor->is_pusat)
                                KP - {{ $karyawan->kantor->nama_kantor }}
                            @else
                                KC - {{ $karyawan->kantor->nama_kantor }}
                            @endif
                        </p>
                        <hr>

                        <strong><i class="fas fa-birthday-cake mr-1"></i> Tempat, Tanggal Lahir</strong>
                        <p class="text-muted">{{ $karyawan->kota->nama_kota }}, {{ \Carbon\Carbon::parse($karyawan->tanggal_lahir)->translatedFormat('d F Y') }}</p>
                        <hr>
