                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group dropleft">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('admin.karyawan.show',$val->id) }}" class="dropdown-item"><i class="fas fa-eye"></i> Detail</a>
                                                ...
                                                <form action="{{ route('admin.karyawan.destroy', $val->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit" class="dropdown-item" onclick="return confirm('Apakah yakin ingin menghapus karyawan {{ $val->nama_lengkap }} ?')"><i class="fas fa-trash"></i> Hapus</button>
                                                </form>
                                            </div>
                                        </div>
                                        @endif
