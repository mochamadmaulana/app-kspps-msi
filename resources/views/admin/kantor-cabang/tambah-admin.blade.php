@extends('layouts.admin', ['title' => 'Tambah Admin '.$cabang->nama_kantor,'icon' => 'fas fa-building'])
@section('content')
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <form action="{{ route('admin.kantor.cabang.admin-store',$cabang->id) }}" method="POST">
                    @csrf
